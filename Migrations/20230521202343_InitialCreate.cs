    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroUsuario", x => new { x.RegistrosId, x.UsuariosId });
                    table.ForeignKey(
                        name: "FK_RegistroUsuario_Registros_RegistrosId",
                        column: x => x.RegistrosId,
                        principalTable: "Registros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistroUsuario_Usuario_UsuariosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroUsuario_UsuariosId",
